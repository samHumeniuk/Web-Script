...
var getPurchasesDispatched = function () {
	...
	target = document.getElementById("purchasesDispatched");
	...
	getPurchases = new XMLHttpRequest();
            ...
            success = function ()
            {
                ...
                console.log(purchasesActualJson.length);
                        ...
                        {
                                searchHtml = "<tr> <td> <h4>No Recently Dispatched Items </h4> </td> </tr>";
                        }
                        else
                        {
	...
	// to be used and the URL to be connected to.
        var phpFile = "./server-side/getPurchasesDispatched.php?" ;
...
window.addEventListener("load", getPurchasesDispatched, false);
